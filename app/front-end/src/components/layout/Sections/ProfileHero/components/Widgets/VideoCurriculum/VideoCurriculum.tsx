...
const VideoCurriculum: React.FC<Props> = ({ userProfile }) => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label={t.videoWidget.playVideo}
      ref={containerRef}
    >
      {embed ? (
            ...
            {showIframe ? (
              ...
              <div className={styles.posterWrap}>
                ...
                <button
                  ...
                  title={t.videoWidget.copyLink}
                  onClick={e => {
                    e.stopPropagation();
                    copyLink();
                  }}
                >
                  {copied ? t.videoWidget.copied : '🔗'}
                </button>
                ...
                >
                  ...
                  <span className={styles.youtubeBadgeText}>{t.videoWidget.openInYoutube}</span>
                </a>
              </div>
            )}
          </div>
        ...
        <video className={styles.video} controls poster={(userProfile as any)?.video_poster || ''}>
          ...
          {t.videoWidget.videoNotSupported}
        </video>
      ) : (
        <div className={styles.emptyPlaceholder}>
          ...
          <div>{t.videoWidget.noVideoAvailable}</div>
        </div>
      )}
    </div>
  );
