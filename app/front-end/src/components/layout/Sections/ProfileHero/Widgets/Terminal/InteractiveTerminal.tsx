// src/components/terminal/InteractiveTerminal.tsx - Fixed version without duplicate responses
import React, { useState, useRef, useEffect } from 'react';
import type { KeyboardEvent } from 'react';
import {
  runCommand,
  getAutocompleteSuggestions,
} from '@/components/layout/Sections/ProfileHero/Widgets/Terminal/commands';
import type { CommandResult } from '@/components/layout/Sections/ProfileHero/Widgets/Terminal/commands';
    ...
    const processingTimeout = setTimeout(
      async () => {
        try {
          ...
          const result: CommandResult = await runCommand(inputValue);
  ...
  return (
    ...
    >
      ...
      <div className="interactive-terminal-header">
        ...
        <div className="interactive-terminal-title">Terminal Interactiva - CV Adrián Dávila</div>
            ...
            <div key={index} className="interactive-history-item">
              ...
              {entry.output.map((line, lineIndex) => (
                <div key={lineIndex} className="interactive-terminal-line">
                  <div className="interactive-output-line line-reveal">{line}</div>
                </div>
              ))}
            </div>
          ))}
          ...
          {!typewriterActive && (
            <div className="interactive-current-input">
              ...
              <input
                ...
                placeholder={
                  showTypingIndicator ? 'Procesando...' : "Escribe un comando... (prueba 'help')"
                }
