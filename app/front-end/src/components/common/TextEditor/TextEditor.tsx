...
const ProjectEditor: React.FC<ProjectEditorProps> = ({
  ...
  const renderToolbar = useCallback(() => {
    ...
    const isSplitMode = currentMode === 'split-horizontal';
    ...
    return (
      <div className="project-editor__toolbar">
        ...
        <div className="project-editor__actions">
          ...
          {/* Vertical split mode removed - kept horizontal split only */}
  ...
  const editorClasses = useMemo(() => {
    return [
      ...
      currentMode === 'split-horizontal' && 'project-editor--split-mode',
    ]
      .filter(Boolean)
      .join(' ');
  }, [currentMode]);
  ...
  return (
    <div className={editorClasses}>
      ...
      <div className="project-editor__content">
        ...
        {(currentMode === 'preview' || currentMode === 'split-horizontal') && (
